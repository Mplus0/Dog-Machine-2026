...
WiFi 网卡：8188ETV，配置为开机自连开发机 WiFi/热点
第二 WiFi 链路：2026-05-31 配置 wlan1 连接机器狗 AP `YSC-JYML-gb9zfq-5G`，获取 `192.168.2.213/24`，用于访问 192.168.2.0/24 内部网和后续机械臂主控；该连接配置为 `ipv4.never-default yes`
```
