...
机器狗内部网络：
  感知主机：192.168.1.103
  感知主机 wlan1：192.168.2.92，连接 YSC-JYML-dt3tfa-5G，仅访问 192.168.2.0/24
  运动主机：192.168.1.120
...
建议把工具优先放在感知主机上运行。开发机访问网页调试工具、D435i 预览和 rosbag 文件时，使用感知主机 `wlan0` 固定地址；感知主机访问运动主机时使用内部网段 `192.168.1.x`。
